...
The result is the ```child``` element is centered within the parent element. It is important to note that this works because the div element is a block-level element.  
